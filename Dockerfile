...
WORKDIR /src
COPY ["MonitoramentoAmbientalEndpoints.csproj", "."]
RUN dotnet restore "./MonitoramentoAmbientalEndpoints.csproj"
COPY . .
WORKDIR "/src/."
...
ENTRYPOINT ["dotnet", "MonitoramentoAmbientalEndpoints.dll"]